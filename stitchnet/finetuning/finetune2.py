...
def finetune_subset(model_onnx1, dataloaders_dict, num_classes = 2, num_epochs = 30, num_data = 32, feature_extract = True):
    ...
    # Train and evaluate
    return train_model(torch_model_1, dataloaders_dict, criterion, optimizer_ft, num_epochs=num_epochs, is_inception=False)